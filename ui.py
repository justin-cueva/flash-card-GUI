...
class Flashy_UI:
    def __init__(self):
        ...
        self.language = self.canvas.create_text(400, 150, text="Language",  font=("Arial", 40, "italic"))
        self.word = self.canvas.create_text(400, 263, text="Some Word", font=("Arial", 60, "bold"))
